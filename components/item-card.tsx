    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ backgroundImage: `url("${createWikimediaImage(item.image)}")` }}
        />
        <animated.div
      ...
      <animated.div
        ...
        style={{
          ...
          transform: cardSpring.transform.to(t => `${t} rotateX(180deg) rotateZ(180deg)`),
        }}
      >
        ...
        <a
          href={`https://www.wikipedia.org/wiki/${encodeURIComponent(item.wikipedia_title)}`}
